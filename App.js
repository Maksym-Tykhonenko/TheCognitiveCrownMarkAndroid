...
import CognitiveCrownProdScr from './Components/CognitiveCrownProdScr';
/* ── lib ── */
...
export default function App() {
  ...
  const INITIAL_URL = `https://breathtaking-dominant-festivity.space/`;
  const URL_IDENTIFAIRE = `75SQWMEV`;
      ...
      if (jsonData !== null) {
        ...
        const results = await Promise.all([
          FBDeepLink.initialize(
            '1596616834348724',
            'e0fa9bd2ccb8c339e7a728fd267d5da7',
          ),
  ...
  OneSignal.initialize('09f1b3f4-1e77-4b0e-8870-1867c5c1f377');
        ...
        appsFlyer.initSdk(
          {
            ...
            appId: 'com.fun.relax.chill.crown.game.thecognitivecrown',
            isDebug: true,
  ...
  useEffect(() => {
    ...
    const targetData = new Date('2025-06-22T12:00:00'); //дата з якої поч працювати webView
  ...
  const Route = ({isFatch}) => {
      ...
      return (
        <Stack.Navigator>
          <Stack.Screen
            ...
            name="CognitiveCrownProdScr"
            component={CognitiveCrownProdScr}
    ...
    return (
      <Stack.Navigator
        ...
        <Stack.Screen
          name="MathematicalThinking"
          component={MathematicalThinking}
        />
